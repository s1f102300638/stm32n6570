...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
/* Application load address - matching the linker script */
#define APPLICATION_ADDRESS     0x34000400
...
int main(void)
{
  ...
  /* Simple delay to ensure everything is stable */
  HAL_Delay(100);
...
static void JumpToApplication(void)
{
    ...
    /* Check if valid stack pointer (RAM address) */
    if ((appStack & 0xFF000000) != 0x34000000)
    {
        /* Invalid stack pointer - application not loaded properly */
        Error_Handler();
    }
